# production-package-layout Specification

## Purpose

Define the compiled distributable product, packaged service and dashboard, runtime assets, dependency boundaries, extension, and licence.
