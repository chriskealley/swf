# packaged-artifact-verification Specification

## Purpose

Define deterministic assembly, exact artifact inspection, isolated installation smoke tests, promotion, and retained release evidence.
