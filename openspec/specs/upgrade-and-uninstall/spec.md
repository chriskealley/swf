# upgrade-and-uninstall Specification

## Purpose

Define upgrade preflight, explicit migration and service replacement, state-preserving uninstall, destructive cleanup, and downgrade safety.
