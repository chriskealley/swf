# Harness Protocol Retention Specification

## Purpose

Define private native-protocol capture, durable replay cursors, controlled inspection, retention, and ownership for harness invocations.
