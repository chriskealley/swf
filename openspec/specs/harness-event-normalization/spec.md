# Harness Event Normalization Specification

## Purpose

Define the common, durable lifecycle model used to interpret supported harness-native event protocols without erasing material capability differences.
