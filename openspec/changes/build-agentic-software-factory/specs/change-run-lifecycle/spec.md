...
- **WHEN** a user tries to create another run for an OpenSpec change already bound to a run
- **THEN** the system rejects creation and directs the user to resume or inspect the existing run
