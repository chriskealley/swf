> **Verification status (2026-08-09):** A spec-to-production traceability audit found that several checked component implementations were not wired into the authenticated service/CLI workflow. Release-blocking tasks were reopened. See `evidence/implementation-verification.md`.
